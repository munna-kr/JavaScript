...
if (!products) deleteAllProdcuts(); // here, products value become true and deleteProducts will execute and delte all products from cart, however number of product is not zero.
